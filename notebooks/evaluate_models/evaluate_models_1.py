...
vae = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/1_proton/gen_vae_175.h5", compile=False)
gan_4 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/1_proton/gen_gan_54.h5", compile=False)
gan_5 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/1_proton/gen_gan_46.h5", compile=False)
sdigan_4 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/1_proton/gen_sdi-gan_101.h5", compile=False)
sdigan_5 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/1_proton/gen_sdi-gan_51.h5", compile=False)
sdigan_reg = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/1_proton/gen_sin-gan_101.h5", compile=False)
sdigan_reg_aux = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/1_proton/gen_sin-gan-aux-reg-arch-2_215.h5", compile=False)
...
sdigan_reg_aux_18 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/18_proton/gen_sin-gan-aux-reg-arch-2_105.h5", compile=False)
...
ws_sdigan_reg_aux_5 = calculate_ws_ch(sdigan_reg_aux_5, x_test, y_test, ch_org, (-1, 56, 30))
print(f"SDI-GAN 5 + reg + aux: {ws_sdigan_reg_aux_5}")

ws_sdigan_reg_aux_18 = calculate_ws_ch(sdigan_reg_aux_18, x_test, y_test, ch_org, (-1, 56, 30))
print(f"SDI-GAN 18 + reg + aux: {ws_sdigan_reg_aux_18}")
