...
vae = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/5_proton/gen_vae_276.h5", compile=False)
gan_4 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/5_proton/gen_gan_198.h5", compile=False)
gan_5 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/5_proton/gen_gan_84.h5", compile=False)
sdigan_4 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/5_proton/gen_sdi-gan_86.h5", compile=False)
sdigan_5 = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/5_proton/gen_sdi-gan_126.h5", compile=False)
sdigan_reg = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/5_proton/gen_sin-gan_45.h5", compile=False)
sdigan_reg_aux = tf.keras.models.load_model("/net/tscratch/people/plgpbedkowski/best_models_h5/5_proton/gen_sin-gan-aux-reg-arch-2_81.h5", compile=False)
