...
for _ in range(0, 3):
    ...
    data_cond = np.float32(data_cond.drop(columns=["std_proton"]))
    ...
    def generator_loss(fake_output, fake_latent,
                       fake_latent_2, noise, noise_2, std):
    ...
    def train_step(batch, step):
        ...
        with tf.GradientTape() as gen_tape, tf.GradientTape() as disc_tape:
            ...
            gen_loss, div_loss = generator_loss(fake_output, fake_latent,
                                                fake_latent_2, noise, noise_2, std)
